...
export function Footer() {
	return (
		<footer
			className={cn(
				"relative mx-auto flex w-full max-w-7xl flex-col items-center justify-center rounded-t-4xl border-t border-secondary px-6 md:rounded-t-6xl md:px-8 shadow-sm",
