...
export const AnnouncementBanner = ({ onClick }: AnnouncementBannerProps) => {
  return (
    ...
    >
      ...
      <div className="max-w-7xl w-full flex items-center justify-between px-4 sm:px-6 md:px-8 gap-3 sm:gap-4">
        {/* Left: Sparkle Badge */}
        ...
        {/* Center: Text message */}
        <div className="flex flex-col items-start md:items-center justify-center flex-1 min-w-0">
          {/* Title row */}
          <div className="text-left md:text-center leading-tight">
            <span className="bg-gradient-to-r from-primary via-sky-500 to-cyan-500 bg-clip-text text-transparent font-extrabold text-[11px] sm:text-sm md:text-lg tracking-wide uppercase mr-1 sm:mr-2">
              EOFY Mega Sale:
            </span>
        ...
        <div className="flex items-center flex-shrink-0">
          <span
            className="inline-flex items-center gap-1 bg-primary text-primary-foreground hover:bg-primary/95 text-[10px] sm:text-xs md:text-base font-bold px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-full shadow-md shadow-primary/10 transition-all duration-200 group-hover:scale-105 active:scale-95 whitespace-nowrap"
          >
            Claim Now
