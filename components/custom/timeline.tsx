  ...
  return (
    <div className="relative mb-8 last:mb-0 md:mb-24 flex flex-col md:flex-row items-center justify-between w-full group">
      ...
      <div className="absolute left-2 md:left-1/2 -translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2 z-10">
        <div className="size-12 md:size-14 rounded-xl md:rounded-2xl bg-background border-2 border-primary flex items-center justify-center shadow-[0_0_15px_rgba(var(--primary),0.3)] group-hover:scale-110 transition-transform duration-300">
      ...
      <div className={cn(
        ...
        <div className="p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border border-border/50 bg-card/60 backdrop-blur-md shadow-lg transition-all duration-500 hover:shadow-primary/5 hover:bg-card dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
          {/* Timeframe Badge */}
          <div className={cn(
            "mb-3 flex",
...
export function Timeline({ items }: { items: TimelineData[] }) {
  return (
    <div className="relative w-full max-w-5xl mx-auto py-8 md:py-24 px-4 overflow-hidden">
      {/* Vertical Line */}
      <div className="absolute left-6 md:left-1/2 -translate-x-1/2 top-4 bottom-4 w-1 md:w-1 bg-border/30">
        <div className="absolute inset-0 bg-gradient-to-b from-primary via-primary/50 to-primary/20 shadow-[0_0_15px_rgba(var(--primary),0.5)]" />
      </div>
