  ...
  return (
    <main className="relative overflow-hidden w-full min-h-screen">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-8 md:py-16 sm:px-6 lg:px-8">
        ...
        {/* Contact CTA */}
        <section className="mt-24 p-8 md:p-12 rounded-[2.5rem] border border-white/40 bg-white/20 backdrop-blur-2xl text-center relative overflow-hidden dark:border-white/10 dark:bg-white/5">
