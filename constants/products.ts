...
export const products: Product[] = [
  {
    ...
    description: [
      ...
      "Stage 2 features high-capacity granular activated carbon to target chemical contaminants, including chlorine, pesticides, and industrial solvents, significantly improving the taste, smell, and overall safety of your water.",
      "Stage 3 employs a powerful combination of KDF-55 redox media and coconut shell carbon to reduce heavy metals (lead, mercury, copper), fluoride, and microplastics while inhibiting bacterial growth and reducing scale buildup.",
      "Designed for high household demand with a peak flow rate of up to 75 litres per minute, this system is ideal for medium-to-large homes, providing a sustainable and cost-effective alternative to bottled water.",
    ],
    features: [
      "5-level, 3-stage purification",
      "Dual-gradient sediment filtration (0.5 micron)",
      "KDF-55 redox technology",
      "Heavy metal & fluoride reduction",
      "Scale inhibition & appliance protection",
      "75L/min high-flow capacity",
      "Water Mark certified components",
    ],
  },
  {
    id: 2,
    ...
    description: [
      ...
      "Integrated filtration reduces sediment, dirt, rust, and chlorine, ensuring crystal-clear and better-tasting water for drinking, cooking, and showering throughout your entire home.",
      "Built with durable, commercial-grade components, the system is suitable for mains, rain, and surface water applications, with versatile indoor or outdoor installation options.",
      "Includes a convenient UV lamp countdown timer and performance alarm to ensure the system consistently operates at its peak efficiency, providing complete peace of mind.",
    ],
    features: [
      ...
      "NSF & Australian Watermark certified",
